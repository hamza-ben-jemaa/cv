...
connection = pymysql.connect(host='sql12.freemysqlhosting.net', user='sql12646621@ec2-52-8-112-233.us-west-1.compute.amazonaws.com', password='ZgFBWfKwXh',port=3306)
